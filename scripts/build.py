...
GAME_ROOT = Path("E:\SteamLibrary\steamapps\common\Stacklands").resolve()
PLUGINS = Path("C:\\Users\\Minh Le\\AppData\\Roaming\\Thunderstore Mod Manager\\DataFolder\\Stacklands\\profiles\\Default\\BepInEx\\plugins").resolve()
